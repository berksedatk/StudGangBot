...
module.exports = {
  ...
  execute(bot, message, args) {
    ...
    if (!args[0]) {
      ...
      logchannel.send({embed: {title: "(To Specific Channel) Say Command Executed!", description:`${message.author} has used the say command in ${message.channel} to ${channel}! Quote: ${quote}`, color:'#f83e42'}})
