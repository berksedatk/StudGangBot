...
module.exports = {
    ...
    async execute(bot, message, args) {
      ...
      user.send(`You nickname in **${message.guild}** has been changed for possibly going against Discord's Terms of Service. We recommend you to change your username. If you don't already know how, you can refer to the articles below to learn how.\n [How to change your username](https://support.discord.com/hc/en-us/articles/213480948-How-do-I-change-my-Username-)\n
