...
5) We strictly forbid the advertisement of other discord servers/communities, social media, third party websites, etc. This includes unsolicited DM and indirect advertisements. (warn/mute/temp-ban)`)    .setColor('#1fbceb')
...
7) We would like to limit topics like this as much as we can due to the possibility of them creating unnecessary dicussions or toxicity. (warn/mute)
\n**__Spamming/Flooding chats is not tolerated__**
8) Spamming/Flooding is highly unappreciated in this server! Examples of spamming would be sending the same/similar messages in a fast or slow interval. Flooding is posting content that overwhelms a users screen. Spamming/Flooding isn't just words, it could be images, links, mentions, copy pasta, etc.
