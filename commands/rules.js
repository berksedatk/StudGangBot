...
7) We would like to limit topics like this as much as we can due to the possibility of them creating unnecessary dicussions or toxicity. This includes topics about religion, politics, self-harm and suicide (can be talked about in confessions or vent chat only), anything that goes against Discord's Terms of Service like gore or loli's, shaming LGBTQ+ individuals, disorders, and many other things alike. (warn/mute/temp-ban)
...
**__"What is this server?"__**\nStudGang is a unique meme-type community specifically focused on socializing with a diverse group of individuals and generally having a good time with others that you can easily become friends with.\n
**__Something to know__**\nOne thing to keep in mind when entering our chat is that we do indeed have a blacklisted words list set out.\nYou can see a full list of blacklisted words [here](https://pastebin.com/4BqkFZC6).
