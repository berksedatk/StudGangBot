...
module.exports = {
  ...
  execute(bot, message, args) {
    ...
    const filter = ["chris","niggеr","negro","n¡gg3r","n¡gger","rape","rap3","r4pe","r4p3","nigger","retard","faggot","n i g g e r","kkk","k k k","beaner","b e a n e r","be a ner","b e a ner","be an er","be an e r",
