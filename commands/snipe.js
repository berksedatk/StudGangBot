...
module.exports = {
  ...
  execute(bot, message, args) {
    ...
    const blacklist = ["534349263422095370","474231127163404289","474231127163404289","642589313988558897",'194666207440273408','495248175808905226','401873000053342208','478721209224265748','230084136868642818','342716056932188161']//if youre seeing this ur seci :flooshed: - no u - NO U - k
    const filter = ["Niggеr","negro","n¡gg3r","n¡gger","rape","rap3","r4pe","r4p3","nigger","retard","faggot","n i g g e r","kkk","k k k","beaner","b e a n e r","be a ner","b e a ner","be an er","be an e r",
