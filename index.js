...
bot.on('ready', () => {
  ...
  setInterval(() => {
    ...
    if (date.getHours() - 5 >= 0 && date.getHours() - 5 < 12){
      bot.channels.cache.get("591123171504029696","752579468404719646").setName('😈 | noodles "sex" dungeon')
...
bot.on("message", msg => {
  ...
  const filter = ["niggеr",'n1gg3r','n1gger','n1gga','n!gger','n!gga','n!gg3r','nlgga','nlgger','nlgg3r','n1gg3r','n1gg@',"nigga","n1gg@","n1gga","negro","n¡gg3r","n¡gger","fag","nigger",
...
'we tback','w e tback','wetback','niggèr','rëtard','rétard','retarted','retarded',
'r.e.t.a.r.d','r3tard','nigg3rs','nigg3r','retar.d','n1gg3r','nlgger','queer','qu e e r','que e r','qu ee r',
'q u e e r','qeer','quuer','quer','fags','chink','coon','dike','niggar','niggur','niger','nigor','nigre','nigar','niggah','nig','nigguh','Niglet','nigglet','Nigra','negra','niggra',
...
'molestar','nibb','nig','nigg','fagot','faget','coon','c o o n','co o n','c o on','coo n','c oon']
